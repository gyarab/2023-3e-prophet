...
from csv_data_handler import reset_history, prepare_array, prepare_hold_array
...
@app.route('/prepare_hold_array')
def prepare_hold_array_endpoint():
    hold_values = prepare_hold_array()
    return jsonify({'hold_values': hold_values})
